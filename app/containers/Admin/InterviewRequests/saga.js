...
import { API_URL, ADMIN, INTERVIEW, STATUS } from 'containers/App/constants';
...
export function* updateStatus(data) {
  ...
  const requestURL = `${API_URL}${ADMIN}${INTERVIEW}${STATUS}`;
...
export default function* adminInterviewForm() {
  yield takeLatest(CHANGE_INTERVIEW_STATUS, updateStatus);
}
