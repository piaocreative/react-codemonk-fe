...
import { forgotPasswordSubmit } from '../saga';

jest.mock('utils/request');

const data = { payload: 'forgotPasswordSubmit' };
...
describe('Testing forgotPasswordSubmit form', () => {
  test('Request With Status One', async () => {
    request.mockImplementation(() => Promise.resolve({ status: 1 }));
    await recordSaga(forgotPasswordSubmit);
