...
import { projectDetailsTabItems } from 'Talent/MyProfileDetail/constants';
...
export class TalentDetailTabs extends React.Component {
  constructor(props) {
    super(props);
...
TalentDetailTabs.defaultProps = defaultProps;
TalentDetailTabs.propTypes = propTypes;
